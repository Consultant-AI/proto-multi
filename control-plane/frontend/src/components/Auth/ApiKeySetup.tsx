      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="anthropic" className="block text-sm font-medium text-theme-secondary">
            ...
            <div>
              <label htmlFor="openai" className="block text-sm font-medium text-theme-secondary">
                OpenAI API Key (GPT)
              </label>
              <input
                id="openai"
            ...
            <div>
              <label htmlFor="google" className="block text-sm font-medium text-theme-secondary">
          ...
          <div className="flex space-x-3">
            <button
              type="button"
              onClick={handleSkip}
              className="flex-1 py-2 px-4 border border-theme text-sm font-medium rounded-md text-theme-secondary bg-theme-tertiary hover:bg-theme-hover focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
              Skip for now
            </button>
            <button
