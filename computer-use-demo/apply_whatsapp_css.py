#!/usr/bin/env python3
"""Apply WhatsApp-style CSS to webui.py"""

# Read the current file
with open('computer_use_demo/webui.py', 'r') as f:
    lines = f.readlines()

# Find the CSS section (line 500-722)
# We'll replace from line 500 (css = """) to line 722 (    """)
...
# Replace lines 500-722 with the new CSS
new_lines = lines[:499] + [whatsapp_css + '\n'] + lines[722:]

# Write back
with open('computer_use_demo/webui.py', 'w') as f:
    f.writelines(new_lines)

print("✅ WhatsApp CSS applied successfully!")
print("Lines replaced: 500-722")
print("New CSS length:", len(whatsapp_css.split('\n')), "lines")
