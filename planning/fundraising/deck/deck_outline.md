...
**Design notes:** Dark theme, minimal text, one key message per slide
**Tone:** Big opportunity. Clear about the vision and path to get there.

**Stage-Specific Focus:**
| Stage | Primary Focus | What You Must Prove |
|-------|---------------|---------------------|
| Pre-Seed | **Team** | Team's capacity to build the product |
| Seed | **Customer Traction** | Initial growth tactics are replicable |
| Series A | **Growth Metrics** | Deep understanding of growth numbers |
| Series B | **Market Domination** | Metrics proving you can take over the market |
...
**Visual:** Simple text: "Autonomous companies are inevitable"
...
- "All the components exist-model capability, computer use, orchestration, tooling. The pieces just need to be connected into a reliable system."
- "AI capabilities will only keep improving. We're not betting on current limitations-we're building infrastructure for capabilities that get better every month."
...
**Visual:** Compounding diagram: Business → Revenue → More businesses → More revenue
...
**Visual:** [Live demo or video embed]

**Content:**
- 90-sec highlight or live demo
...
| Model | How It Works |
|-------|--------------|
| AI does everything | Fully automated, end-to-end |
| AI hires people | Proto recruits and manages human workers |
| AI delegates to humans | Break down work, assign to people, synthesize |
...
**Visual:** Grid showing business types with examples
...
- Technical founder + need high-quality engineers (CTO-level)
...
- If you're bored making the deck, investors will be bored watching it
...
- Animation (distracting in calls)
- Overselling or being vague

**Tools:**
- Figma for design
- Export to PDF (not PPTX)
- Test screen share before calls
...
**During the Pitch:**
- Total time: 15-20 minutes with demo
- Demo in the middle (slide 5) to break up talking
