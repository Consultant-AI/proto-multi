# Proto Live Demo Script

**Duration:** 5 minutes
**Goal:** Show Proto executing a complex, multi-step task that demonstrates the autonomous company capability

---

## Pre-Demo Setup (Before Call)

1. Open Proto with a fresh session
2. Have a sample project ready
3. Ensure cloud VM is provisioned and connected
4. Test that all tabs work: Files, Terminal, Browser, Computer
...
**[Show: Proto main interface with chat panel]**

> "This is Proto-infrastructure for autonomous companies. On the left is the agent chat where I give instructions. On the right, Proto has access to files, terminal, browser, and can control computers directly. Watch how it coordinates specialist agents to complete a complex task."

---

### PART 1: Task Delegation (60 seconds)

**[Click: Chat input]**

> "I'm going to give Proto a complex task-something that would normally require multiple specialists working together."

**[Type your chosen task, e.g.:]**
- Marketing: `Create a complete campaign for a B2B SaaS product. Research competitors, write ad copy, design landing page structure.`
- Development: `Build a simple API endpoint with tests. Research best practices, write the code, create documentation.`
- Research: `Analyze the market for AI coding assistants. Create a competitive landscape report with recommendations.`
...
> "This isn't one AI-it's specialist agents coordinating like a real organization. Each one is optimized for its specific task."
...
### PART 3: Output Generation (60 seconds)

**[Click: Files tab]**

> "Let's look at what it's produced."

**[Open generated files]**

> "Notice the quality-this isn't generic output. Each specialist agent produced work in their domain of expertise."

**[Open another file showing coordination]**

> "And see how the work connects together. The agents aren't working in isolation-they're coordinating, passing context, building on each other's output."
...
|---------------|---------|
| Agent stuck | Say "Let me restart this agent" and refresh |
| Cloud VM disconnects | Switch to local demo only |
| Task takes too long | Jump to pre-saved files in `demo_fallback/` |
| Complete failure | Play pre-recorded video |
